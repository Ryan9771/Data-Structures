...
public final class Node<K extends Comparable<? super K>, V> {
  ...
  public Node<K, V> rotateRight() {
    Node<K, V> tempNode = this.left;
    this.setLeft(tempNode.right);
    this.reparent(tempNode);
    tempNode.setRight(this);
    return tempNode;
  }

  public Node<K, V> rotateLeft() {
    Node<K, V> tempNode = this.right;
    this.setRight(tempNode.left);
    this.reparent(tempNode);
    tempNode.setLeft(this);
    return tempNode;
  }
